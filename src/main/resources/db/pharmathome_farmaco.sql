...
CREATE TABLE `farmaco` (
  ...
  `Disponibilita` smallint DEFAULT NULL,
  `QuantitaMinima` smallint DEFAULT NULL,
  PRIMARY KEY (`Id`)
...
INSERT INTO `farmaco` VALUES (5,'100','OKI','BAYER',9,100,1),(6,'101','OKI TASK','BAYER',11,2,1),(8,'102','AULIN','ANGELINI',8,20,1),(9,'103','BRUFEN','FARMACIA',10,10,1),(10,'104','ASPIRINA C','FARMACIA',7,0,1);
